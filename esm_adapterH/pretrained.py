...
import esm_adapterH
from esm_adapterH.model.esm2 import ESM2
...
def load_model_and_alphabet_hub(model_name, args=None):
    model_data, regression_data = _download_model_and_regression_data(model_name)
    return load_model_and_alphabet_core(model_name, model_data, regression_data, args)


def load_model_and_alphabet_local(model_location,args=None):
...
def _load_model_and_alphabet_core_v1(model_data):
    import esm  # since esm_adapterH.inverse_folding is imported below, you actually have to re-import esm here

    alphabet = esm_adapterH.Alphabet.from_architecture(model_data["args"].arch)
    ...
    if model_data["args"].arch == "roberta_large":
        ...
        model_type = esm_adapterH.ProteinBertModel
        ...
        model_type = esm_adapterH.MSATransformer

    elif "invariant_gvp" in model_data["args"].arch:
        import esm_adapterH.inverse_folding

        model_type = esm_adapterH.inverse_folding.gvp_transformer.GVPTransformerModel
...
def _load_model_and_alphabet_core_v2(model_data, args=None):
    ...
    alphabet = esm_adapterH.data.Alphabet.from_architecture("ESM-1b")
    model = ESM2(
        ...
        #num_end_adapter_layers=args,
        adapter_args=args,
    )
    return model, alphabet, state_dict


def load_model_and_alphabet_core(model_name, model_data, regression_data=None, args=None):
    if regression_data is not None:
        model_data["model"].update(regression_data["model"])

    if model_name.startswith("esm2"):
        model, alphabet, model_state = _load_model_and_alphabet_core_v2(model_data, args)
    else:
...
def esm_msa1_t12_100M_UR50S():
    warnings.warn(
        ...
        "please use ESM-MSA-1b: esm_adapterH.pretrained.esm_msa1b_t12_100M_UR50S()",
    )
...
def esm2_t6_8M_UR50D(args=None):
    """6 layer ESM-2 model with 8M params, trained on UniRef50.

    Returns a tuple of (Model, Alphabet).
    """
    return load_model_and_alphabet_hub("esm2_t6_8M_UR50D", args)


def esm2_t12_35M_UR50D(args=None):
    """12 layer ESM-2 model with 35M params, trained on UniRef50.

    Returns a tuple of (Model, Alphabet).
    """
    return load_model_and_alphabet_hub("esm2_t12_35M_UR50D", args)


def esm2_t30_150M_UR50D(args=None):
    """30 layer ESM-2 model with 150M params, trained on UniRef50.

    Returns a tuple of (Model, Alphabet).
    """
    return load_model_and_alphabet_hub("esm2_t30_150M_UR50D", args)


def esm2_t33_650M_UR50D(args=None):
    """33 layer ESM-2 model with 650M params, trained on UniRef50.

    Returns a tuple of (Model, Alphabet).
    """
    return load_model_and_alphabet_hub("esm2_t33_650M_UR50D", args)


def esm2_t36_3B_UR50D(args=None):
    """36 layer ESM-2 model with 3B params, trained on UniRef50.

    Returns a tuple of (Model, Alphabet).
    """
    return load_model_and_alphabet_hub("esm2_t36_3B_UR50D", args)


def esm2_t48_15B_UR50D(args=None):
    ...
    Returns a tuple of (Model, Alphabet).
    """
    return load_model_and_alphabet_hub("esm2_t48_15B_UR50D", args)
...
def esmfold_v0():
    ...
    """
    import esm_adapterH.esmfold.v1.pretrained
    return esm_adapterH.esmfold.v1.pretrained.esmfold_v0()
...
def esmfold_v1():
    ...
    """
    import esm_adapterH.esmfold.v1.pretrained
    return esm_adapterH.esmfold.v1.pretrained.esmfold_v1()
...
def esmfold_structure_module_only_8M():
    ...
    """
    import esm_adapterH.esmfold.v1.pretrained
    return esm_adapterH.esmfold.v1.pretrained.esmfold_structure_module_only_8M()
...
def esmfold_structure_module_only_8M_270K():
    ...
    """
    import esm_adapterH.esmfold.v1.pretrained
    return esm_adapterH.esmfold.v1.pretrained.esmfold_structure_module_only_8M_270K()
...
def esmfold_structure_module_only_35M():
    ...
    """
    import esm_adapterH.esmfold.v1.pretrained
    return esm_adapterH.esmfold.v1.pretrained.esmfold_structure_module_only_35M()
...
def esmfold_structure_module_only_35M_270K():
    ...
    """
    import esm_adapterH.esmfold.v1.pretrained
    return esm_adapterH.esmfold.v1.pretrained.esmfold_structure_module_only_35M_270K()
...
def esmfold_structure_module_only_150M():
    ...
    """
    import esm_adapterH.esmfold.v1.pretrained
    return esm_adapterH.esmfold.v1.pretrained.esmfold_structure_module_only_150M()
...
def esmfold_structure_module_only_150M_270K():
    ...
    """
    import esm_adapterH.esmfold.v1.pretrained
    return esm_adapterH.esmfold.v1.pretrained.esmfold_structure_module_only_150M_270K()
...
def esmfold_structure_module_only_650M():
    ...
    """
    import esm_adapterH.esmfold.v1.pretrained
    return esm_adapterH.esmfold.v1.pretrained.esmfold_structure_module_only_650M()
...
def esmfold_structure_module_only_650M_270K():
    ...
    """
    import esm_adapterH.esmfold.v1.pretrained
    return esm_adapterH.esmfold.v1.pretrained.esmfold_structure_module_only_650M_270K()
...
def esmfold_structure_module_only_3B():
    ...
    """
    import esm_adapterH.esmfold.v1.pretrained
    return esm_adapterH.esmfold.v1.pretrained.esmfold_structure_module_only_3B()
...
def esmfold_structure_module_only_3B_270K():
    ...
    """
    import esm_adapterH.esmfold.v1.pretrained
    return esm_adapterH.esmfold.v1.pretrained.esmfold_structure_module_only_3B_270K()
...
def esmfold_structure_module_only_15B():
    ...
    """
    import esm_adapterH.esmfold.v1.pretrained
    return esm_adapterH.esmfold.v1.pretrained.esmfold_structure_module_only_15B()
