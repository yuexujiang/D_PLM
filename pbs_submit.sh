...
num=0
split_num=5
outfolder='/cluster/pixstor/xudong-lab/yuexu/D_PLM/permutate/processed_Atlas_data_permutate'
...
num=0
split_num=5
outfolder='/cluster/pixstor/xudong-lab/yuexu/D_PLM/permutate/processed_Atlas_v2added_permutate'
sbatch --export=folder=$folder,num=$num,outfolder=$outfolder,split_num=$split_num, \
     -J ${task} \
     data_process.pbs
...
task="vivit_perameter1"
config_path='./configs_hell/gvp_v2/config2.yaml'
result_path='./results/vivit_parameter1/'
sbatch --export=config_path=$config_path,result_path=$result_path, \
     -J ${task} \
     run_yjm85.sh

task="vivit_mlm"
config_path='./configs_hell/gvp_v2/config3.yaml'
result_path='./results/vivit_mlm/'
sbatch --export=config_path=$config_path,result_path=$result_path, \
     -J ${task} \
     run_yjm85.sh

task="vivit_ft"
config_path='./configs_hell/gvp_v2/config4.yaml'
result_path='./results/vivit_ft/'
sbatch --export=config_path=$config_path,result_path=$result_path, \
     -J ${task} \
     run_yjm85.sh

task="vivit_lora"
config_path='./configs_hell/gvp_v2/config5.yaml'
result_path='./results/vivit_lora/'
sbatch --export=config_path=$config_path,result_path=$result_path, \
     -J ${task} \
     run_yjm85.sh

task="vivit_lr"
config_path='./configs_hell/gvp_v2/config6.yaml'
result_path='./results/vivit_lr/'
sbatch --export=config_path=$config_path,result_path=$result_path, \
     -J ${task} \
     run_yjm85.sh

task="vivit_continue"
config_path='./configs_hell/gvp_v2/config_continue.yaml'
result_path='./results/vivit_continue/'
sbatch --export=config_path=$config_path,result_path=$result_path, \
     -J ${task} \
     run_yjm85.sh

task="vivit_ft2"
config_path='./configs_hell/gvp_v2/config_ft2.yaml'
result_path='./results/vivit_ft2/'
sbatch --export=config_path=$config_path,result_path=$result_path, \
     -J ${task} \
     run_yjm85.sh
...
task="lora3_eval"
model_location='/cluster/pixstor/xudong-lab/yuexu/D_PLM/results/vivit_lora3/checkpoints/checkpoint_best_val_rmsf_cor.pth'
config_path='/cluster/pixstor/xudong-lab/yuexu/D_PLM/results/vivit_lora3/config_lora3.yaml'
scoring_strategy='wt-mt-RLA' #"mask-marginals
sbatch --export=model_location=$model_location,config_path=$config_path,scoring_strategy=$scoring_strategy, \
       -J ${task} \
       ./evaluate/mutation_effect_ESM1v.pbs
